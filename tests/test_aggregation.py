...
from automated_security_helper.models.aggregation import FindingAggregator, TrendAnalyzer

@pytest.fixture
def sample_finding():
    """Create a sample finding for testing."""
    scanner = Scanner(name="test_scanner", version="1.0.0", rule_id="RULE-001", type="SAST")
...
def test_finding_aggregator_group_by_type(sample_finding):
    ...
    finding2 = BaseFinding(
        ...
        description=sample_finding.description,
        severity=sample_finding.severity,
        scanner=Scanner(name="test_scanner", version="1.0.0", rule_id="RULE-002", type="SAST"),
        location=sample_finding.location
    )
    aggregator.add_finding(sample_finding)
    aggregator.add_finding(finding2)
