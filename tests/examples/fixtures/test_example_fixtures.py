...
def env_vars():
    ...
    os.environ["ASH_CONFIG_PATH"] = "/tmp/config.yaml"
...
def test_factory_fixtures(make_python_file, temp_dir):
    """Test using factory fixtures."""
    # Create Python files with different content
    file1 = make_python_file("print('Hello, world!')", temp_dir)
...
def test_env_vars_fixture(env_vars):
    """Test using environment variable fixtures."""
    assert os.environ["ASH_CONFIG_PATH"] == "/tmp/config.yaml"
