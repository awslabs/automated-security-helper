...
class TestWizardCommand:
    ...
    def _build_input(
        ...
        if scanner_answers is None:
            scanner_answers = {python_name: True for python_name, _ in scanner_names}
        for python_name, _ in scanner_names:
        ...
        if reporter_answers is None:
            reporter_answers = {python_name: True for python_name, _ in reporter_names}
        for python_name, _ in reporter_names:
