...
PR#274 Bug #33: debug_echo returns None, passes tuple to logger.
"""
...
class TestDebugEchoReturnValue:
    ...
    def test_debug_echo_returns_string(self):
        ...
        assert isinstance(result, str), (
            f"debug_echo returned {type(result)}, expected str"
        )
    ...
    def test_debug_echo_passes_string_not_tuple(self):
        ...
        with patch(
            "automated_security_helper.utils.get_scan_set.ASH_LOGGER"
        ) as mock_logger:
