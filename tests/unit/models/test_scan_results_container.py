...
class TestScanResultsContainer:
    """Test cases for ScanResultsContainer."""

    def test_scan_results_container_initialization(self):
    ...
    def test_scan_results_container_add_metadata(self):
    ...
    def test_scan_results_container_set_raw_results(self):
