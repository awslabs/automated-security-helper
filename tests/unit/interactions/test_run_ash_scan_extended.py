"""Extended unit tests for run_ash_scan module to increase coverage."""
...
def test_run_ash_scan_container_mode_basic(mock_run_ash_container, mock_get_logger):
    """Test run_ash_scan in container mode with basic options."""
    # Setup mocks
...
def test_run_ash_scan_local_mode_basic(mock_orchestrator_class, mock_get_logger):
    """Test run_ash_scan in local mode with basic options."""
    # Setup mocks
    mock_logger = MagicMock()
    mock_get_logger.return_value = mock_logger
...
def test_run_ash_scan_container_mode_with_debug(
    ...
    """Test run_ash_scan in container mode with debug enabled."""
    # Setup mocks
    mock_logger = MagicMock()
    mock_get_logger.return_value = mock_logger
