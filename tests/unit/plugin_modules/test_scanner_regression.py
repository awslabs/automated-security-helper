...
PR#274 Bug #24: bandit excluded_paths accumulates across calls (from low)
PR#274 Bug #9: get_reporter_mappings __class__.__name__ on class object (from high)
PR#274 Bug #31: Duplicate "xml" in KNOWN_SCANNABLE_EXTENSIONS (from low)
"""
...
# ---------------------------------------------------------------------------
# PR#274 Bug #9 -- get_reporter_mappings.py: __class__.__name__ on class object
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# PR#274 Bug #31 -- Duplicate "xml" in KNOWN_SCANNABLE_EXTENSIONS
# ---------------------------------------------------------------------------
