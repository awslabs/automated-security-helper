...
> **Floating tag `v3`**: We also maintain a `v3` floating tag that always points to the latest stable v3.x release. You can use `@v3` instead of `@v3.5.7` to stay up to date automatically. Pin a specific version when you need reproducible builds.
