...
| [cdk-nag](https://github.com/cdklabs/cdk-nag)                 | IaC       | CloudFormation (see FAQ regarding CDK application coverage)                                  |
...
- On Windows: WSL2 is typically required for running Linux containers due to the requirements of the container runtime
...
- **Q: How do I run ASH in CI/CD pipelines?**
  ...
  A: ASH can be run in container mode in any CI/CD environment that supports containers. See the [tutorials](tutorials/running-ash-in-ci.md) for examples.
