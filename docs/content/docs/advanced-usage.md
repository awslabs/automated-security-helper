...
> **Tip**: The examples below use pinned versions (`@v3.5.0`) for reproducibility. You can also use the `v3` floating tag (`@v3`) to always get the latest stable v3.x release, though pinned versions are recommended for CI/CD.
