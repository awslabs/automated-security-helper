...
function ash { uvx git+https://github.com/awslabs/automated-security-helper.git@v3.1.6 $args }
...
```bash
# Works on Windows, macOS, and Linux
git clone https://github.com/awslabs/automated-security-helper.git --branch v3.1.6
...
```bash
pip install --upgrade git+https://github.com/awslabs/automated-security-helper.git@v3.1.6
```
