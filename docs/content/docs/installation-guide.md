...
pipx install git+https://github.com/awslabs/automated-security-helper.git@v3.2.0
...
```bash
pip install --upgrade git+https://github.com/awslabs/automated-security-helper.git@v3.2.0
```
