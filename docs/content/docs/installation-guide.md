...
pipx install git+https://github.com/awslabs/automated-security-helper.git@v3.1.9
...
```bash
pip install --upgrade git+https://github.com/awslabs/automated-security-helper.git@v3.1.9
```
