...
function ash { uvx git+https://github.com/awslabs/automated-security-helper.git@v3.1.5 $args }
...
```bash
pip install --upgrade git+https://github.com/awslabs/automated-security-helper.git@v3.1.5
```
