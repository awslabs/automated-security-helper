...
> **Floating tag `v3`**: You can also use `@v3` instead of `@v3.6.0` to always get the latest stable v3.x release. Pin a specific version when you need reproducible builds.
