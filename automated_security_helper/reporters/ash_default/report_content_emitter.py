...
class ReportContentEmitter:
    """
    A reusable class for generating report content from AshAggregatedResult.
    ...
    def __init__(self, model: "AshAggregatedResult"):
        """Initialize with an AshAggregatedResult."""
        self.model = model
