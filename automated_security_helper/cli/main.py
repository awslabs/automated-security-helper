...
from automated_security_helper.cli.ui.start_ash_ui import start_ash_ui_cli_command
...
app.command(
    name="ui",
    help="Starts the ASH UI Streamlit app on a local port",
)(start_ash_ui_cli_command)
