...
class MemoryLogger(cdk_nag.INagLogger):
    results: list[cdk_nag.NagLoggerBaseData] = []
    ...
    def on_compliance(
        ...
        *,
        ...
        #     compliance_frameworks=[nag_pack_name],
        #     id=rule_id,
        #     title=rule_original_name,
        #     severity="INFO",
        #     resource_name=resource.logical_id,
        #     resource_type=resource.cfn_resource_type,
        #     description=rule_info,
        #     location=Location(
        #         file_path=rule_id,
        #     ),
        #     remediation=rule_explanation,
        # )
        # self.results.append(finding.model_dump_json())
    ...
    def on_non_compliance(
        ...
        *,
        ...
        return super().on_non_compliance(
    ...
    def on_not_applicable(
        ...
        *,
        ...
        return super().on_not_applicable(
            nag_pack_name=nag_pack_name,
            resource=resource,
            rule_explanation=rule_explanation,
            rule_id=rule_id,
    ...
    def on_suppressed_error(
        ...
        *,
        ...
        return super().on_suppressed_error(
